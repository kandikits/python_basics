...
SET REPO_DOWNLOAD_URL=https://github.com/kandikits/python_basics/releases/download/v1.0/python_basics-main.zip
SET REPO_DEPENDENCIES_URL=https://github.com/kandikits/python_basics/raw/main/requirements.txt
SET REPO_NAME=python_basics-main.zip
SET EXTRACTED_REPO_DIR=python_basics-main
SET NOTEBOOK_NAME=Python Basic Programs.ipynb
where /q python
IF ERRORLEVEL 1 (
	ECHO==========================================================================
